...
measures_gs <- gs_title("measures")

measures <- measures_gs %>% gs_read_all()

write_rds(measures, "data/measures.rds")

```

```{r get timer data, eval=FALSE}
timer_raw <- read_csv("~/Downloads/Details-20170101-20200228.csv")
write_rds(timer_raw, "data/timer_raw.rds")
```
