...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{\emph{perennial work in progress} Tuesday 14 May 2019}
...
\midrule
\endhead
phoenix & Tuesday 2 April 2019 & Tuesday 14 May 2019\tabularnewline
\bottomrule
\end{longtable}
...
\hline
\$*\$ & \$\textbackslash{}forall\$ & \$\textbackslash{}psi\$ & what is on fire? & task or project must be due today and someone else will get stuffed around if I don't do it\\
\hline
\$*\$ & \$\textbackslash{}natural\$ & \$\textbackslash{}psi\$ & inboxes & email, 3c2 , handbag, unpack suitcase\\
\hline
\$*\$ & \$\textbackslash{}natural\$ & \$\textbackslash{}psi\$ & 3c\textasciicircum{}2 inbox & NA\\
\hline
\$*\$ & \$\textbackslash{}sharp\$ & \$\textbackslash{}pi\$ & handbag & NA\\
\hline
\$*\$ & \$\textbackslash{}sharp\$ & \$\textbackslash{}pi\$ & unpack suitcase & NA\\
\hline
...
\hline
\$\textbackslash{}sim\$ & \$\textbackslash{}forall\$ & \$\textbackslash{}psi\$ & monthly log & each project should either have an associated collection, or a git hub repo or issue, location tagged in monthly log\\
\hline
\$\textbackslash{}sim\$ & \$\textbackslash{}natural\$ & \$\textbackslash{}psi\$ & ynab & finish pom\\
\hline
\$\textbackslash{}sim\$ & \$\textbackslash{}forall\$ & \$\textbackslash{}psi\$ & thread & NA\\
\hline
\end{tabular}
...
\$*\$ & \$\textbackslash{}sharp\$ & \$\textbackslash{}pi\$ & unpack suitcase & NA\\
\hline
\$\textbackslash{}varnothing\$ & \$\textbackslash{}natural\$ & \$\textbackslash{}pi\$ & write to dani & check in with dani on slack\\
\hline
\$\textbackslash{}varnothing\$ & \$\textbackslash{}sharp\$ & \$\textbackslash{}pi\$ & wash brushes & wash brushes\\
\hline
