...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{measures }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pluck}\NormalTok{(}\StringTok{"data"}\NormalTok{, }\StringTok{"signifiers"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{LaTeX) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mdat <-}\StringTok{ }\KeywordTok{wrangle_measures}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Warning: Unknown levels in `f`: v
\end{verbatim}

\begin{verbatim}
## Joining, by = c("category", "category_workload")
\end{verbatim}

\begin{verbatim}
## Warning: Column `category` joining factor and character vector, coercing
## into character vector
\end{verbatim}

\begin{verbatim}
## Warning: Unknown levels in `f`: nothing
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mdat }\OperatorTok{%>%}\StringTok{ }
\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(category_workload, daily_workload, period, category) }\OperatorTok{%>%}
...
\StringTok{    }\NormalTok{ggmosaic}\OperatorTok{::}\KeywordTok{geom_mosaic}\NormalTok{(}
      \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{product}\NormalTok{(daily_workload),}
          \DataTypeTok{fill =}\NormalTok{ category_workload,}
          \DataTypeTok{weight =}\NormalTok{ n)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale_fill_grey}\NormalTok{(}\DataTypeTok{start =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{end =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}
\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.y =} \KeywordTok{element_blank}\NormalTok{(),}
      \DataTypeTok{axis.ticks.y =} \KeywordTok{element_blank}\NormalTok{(),}
      \DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{35}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{))}\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(period }\OperatorTok{~}\StringTok{ }\NormalTok{category)}
\end{Highlighting}
\end{Shaded}
