...
```{r rituals packages, message=FALSE}
...
and replace tabs for `r quaver()` daily log and `r quavers()` monthly log. 

<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">Daily log and monthly log <a href="https://t.co/Wdtix2rZHJ">pic.twitter.com/Wdtix2rZHJ</a></p>&mdash; Charles T. Gray (@cantabile) <a href="https://twitter.com/cantabile/status/1132814593389207555?ref_src=twsrc%5Etfw">May 27, 2019</a></blockquote>
...
Add $\sharp \pi \cdot$ coffee to `r quaver()` daily log. You deserve it. 

Add $\star$ priority [daily tasks](#daily-tasks). 

Add [$\overline o$](#review) and $\pi$ to the [order of events](#dayview:order-of-events).

## `r quaver()` day view {#dayview:day-view}
...
<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">Day view <a href="https://t.co/JL1BMvzO5C">pic.twitter.com/JL1BMvzO5C</a></p>&mdash; Charles T. Gray (@cantabile) <a href="https://twitter.com/cantabile/status/1133129034013872128?ref_src=twsrc%5Etfw">May 27, 2019</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>


## `r quaver()` daily tasks {#daily-tasks}

```{r wrangle tasks}

# wrangling tasks for output
# mighth port wrangle functions over to dontpanic at some point
...
<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">Priority daily tasks <a href="https://t.co/dFfNMEK0Hx">pic.twitter.com/dFfNMEK0Hx</a></p>&mdash; Charles T. Gray (@cantabile) <a href="https://twitter.com/cantabile/status/1132817367539445761?ref_src=twsrc%5Etfw">May 27, 2019</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
### `r quaver()` daily log {#dayview:daily-log}
...
<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">Task cycle <a href="https://t.co/HuBwLgXP3x">pic.twitter.com/HuBwLgXP3x</a></p>&mdash; Charles T. Gray (@cantabile) <a href="https://twitter.com/cantabile/status/1132818454191325184?ref_src=twsrc%5Etfw">May 27, 2019</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
## `r quavers()` monthly log {#monthly-log}

Projects that will take `r quavers()` longer than a day. 

<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">Monthly log <a href="https://t.co/4ynoMzcLnI">pic.twitter.com/4ynoMzcLnI</a></p>&mdash; Charles T. Gray (@cantabile) <a href="https://twitter.com/cantabile/status/1133129102624378880?ref_src=twsrc%5Etfw">May 27, 2019</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
## `r fermata()` waiting {#dayview:waiting}
