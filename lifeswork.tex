...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{timer_raw <-}\StringTok{ }\KeywordTok{read_rds}\NormalTok{(}\StringTok{"data/timer_raw.rds"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{measures <-}\StringTok{ }\KeywordTok{read_rds}\NormalTok{(}\StringTok{"data/measures.rds"}\NormalTok{)}
...
\NormalTok{goals <-}\StringTok{ }\NormalTok{measures }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pluck}\NormalTok{(}\StringTok{"workload"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(workload, phi_hrs, theta_hrs, psi_hrs) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"category"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"poms"}\NormalTok{, phi_hrs, theta_hrs, psi_hrs) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key =} \StringTok{"workload"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"poms"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{category =} \KeywordTok{str_sub}\NormalTok{(category, }\DataTypeTok{end =} \DecValTok{-5}\NormalTok{))}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{hrs =} \KeywordTok{sum}\NormalTok{(duration_hrs)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(goals) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{category_workload =} \KeywordTok{case_when}\NormalTok{(}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{daily_workload =} \KeywordTok{case_when}\NormalTok{(}
      \KeywordTok{any}\NormalTok{(hrs }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{~}\StringTok{ }\NormalTok{intensities[[}\DecValTok{1}\NormalTok{]],}
      ...
      \KeywordTok{any}\NormalTok{(hrs }\OperatorTok{<}\StringTok{ }\NormalTok{moderate) }\OperatorTok{~}\StringTok{ }\NormalTok{intensities[[}\DecValTok{3}\NormalTok{]],}
      \KeywordTok{any}\NormalTok{(hrs }\OperatorTok{<}\StringTok{ }\NormalTok{hardcore) }\OperatorTok{~}\StringTok{ }\NormalTok{intensities[[}\DecValTok{4}\NormalTok{]],}
...
\NormalTok{count_workload <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{days =} \DecValTok{10}\NormalTok{)\{}

\NormalTok{  counts <-}\StringTok{ }\NormalTok{daily_work }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(date }\OperatorTok{>}\StringTok{ }\NormalTok{lubridate}\OperatorTok{::}\KeywordTok{today}\NormalTok{() }\OperatorTok{-}\StringTok{ }\NormalTok{days) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(category) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{count}\NormalTok{(category_workload)}
...
\NormalTok{quinque <-}\StringTok{ }\KeywordTok{count_workload}\NormalTok{(}\DataTypeTok{days =} \DecValTok{5}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{period =} \StringTok{"v"}\NormalTok{)}

\NormalTok{decade <-}\StringTok{  }\KeywordTok{count_workload}\NormalTok{(}\DataTypeTok{days =} \DecValTok{10}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{period =} \StringTok{"x"}\NormalTok{)}

\NormalTok{century <-}\StringTok{ }\KeywordTok{count_workload}\NormalTok{(}\DataTypeTok{days =} \DecValTok{100}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{period =} \StringTok{"c"}\NormalTok{)}

\NormalTok{daily_measures <-}\StringTok{ }\KeywordTok{suppressMessages}\NormalTok{(\{}
  \KeywordTok{count_workload}\NormalTok{(}\DataTypeTok{days =} \DecValTok{1000}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{period =} \StringTok{"m"}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    ...
    \DataTypeTok{period =} \KeywordTok{fct_relevel}\NormalTok{(period, }\StringTok{"v"}\NormalTok{, }\StringTok{"x"}\NormalTok{, }\StringTok{"c"}\NormalTok{, }\StringTok{"m"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{full_join}\NormalTok{(daily_work) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{daily_workload =} \KeywordTok{fct_relevel}\NormalTok{(daily_workload, intensities),}
    \DataTypeTok{category_workload =} \KeywordTok{fct_relevel}\NormalTok{(category_workload, intensities))  }
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
